...
**Status:** COMPLETE, awaiting peer review (2026-05-11).
...
- P2-13c (Transcripts + Transfers + Lockers + Reporting Periods + Awards + Medical Exemptions, 8 tables, ~20 endpoints) — this commit
...
| Kafka emit topics               | **3** — `sis.avatar.reviewed`, `sis.parent_update.submitted`, `sis.parent_update.reviewed` (P2-13a) + `sis.graduation.at_risk` (P2-13b)                                                                                                              |
| Vitest spec count               | 647 → **696** (16 P2-13c + earlier P2-13a + P2-13b)                                                                                                                                                                                                  |
