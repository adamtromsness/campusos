...
- **Step 6 calendar / coverage NestJS module.** ~12 endpoints + 2 Kafka emits (`sch.coverage.needed`, `sch.coverage.assigned`) + 1 new consumer (CoverageConsumer subscribing to `hr.leave.coverage_needed`).
