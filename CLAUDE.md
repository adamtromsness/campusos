...
apps/api/src/classroom/  → M21 Classroom (Cycle 2): assignment + category CRUD landed in Step 4 (AssignmentService, CategoryService, controllers, DTOs). Submissions, grading, gradebook snapshot worker land in Steps 5–6.
