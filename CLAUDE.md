...
- Cycle 3: Communications — IN PROGRESS (Steps 0–3 done — ADR-057 envelope + messaging schema + notifications/announcements schema + moderation schema + first platform-schema additions since Cycle 0; Steps 4–11 pending: seed, consumers, NestJS modules, UI, vertical slice)
