...
- Cycle 3: Communications — IN PROGRESS (Steps 0–1 done — ADR-057 envelope + messaging schema; Steps 2–11 pending: notifications schema, moderation, seed, consumers, NestJS modules, UI, vertical slice)
