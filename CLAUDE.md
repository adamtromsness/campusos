...
- Cycle 3: Communications — IN PROGRESS (Steps 0–2 done — ADR-057 envelope + messaging schema + notifications/announcements schema; Steps 3–11 pending: moderation schema, seed, consumers, NestJS modules, UI, vertical slice)
