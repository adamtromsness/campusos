...
import { WorkflowsModule } from '@modules/m02-workflows/m02-workflows.module';
import { TasksModule } from '@modules/m03-tasks/m03-tasks.module';
...
import { SchedulingModule } from '@modules/m22-scheduling/m22-scheduling.module';
import { M23HealthModule } from '@modules/m23-health/m23-health.module';
import { LibraryModule } from '@modules/m24-library/m24-library.module';
import { CurriculumModule } from '@modules/m25-curriculum/m25-curriculum.module';
import { PortfolioModule } from '@modules/m26-portfolio/m26-portfolio.module';
...
import { PublicationsModule } from '@modules/m42-publications/m42-publications.module';
import { TransportModule } from '@modules/m61-transport/m61-transport.module';
import { ItModule } from '@modules/m62-it/m62-it.module';
import { FoodServiceModule } from '@modules/m63-food-service/m63-food-service.module';
import { M64ClubsModule } from '@modules/m64-clubs/m64-clubs.module';
import { FacilitiesModule } from '@modules/m65-facilities/m65-facilities.module';
import { AthleticsModule } from '@modules/m66-athletics/m66-athletics.module';
...
import { SubstitutesModule } from '@modules/m82-substitutes/m82-substitutes.module';
import { FinanceModule } from '@modules/m83-finance/m83-finance.module';
import { PaymentsModule } from '@modules/m84-payments/m84-payments.module';
import { AccreditationModule } from '@modules/m85-accreditation/m85-accreditation.module';
import { ProcurementModule } from '@modules/m86-procurement/m86-procurement.module';
import { M87SafetyModule } from '@modules/m87-safety/m87-safety.module';
import { VisitorsModule } from '@modules/m90-visitors/m90-visitors.module';
import { TicketsModule } from '@modules/m60-tickets/m60-tickets.module';
import { EngagementModule } from '@modules/m100-engagement/m100-engagement.module';
import { EventsModule } from '@modules/m101-events/m101-events.module';
import { AlumniModule } from '@modules/m102-alumni/m102-alumni.module';
import { M103GroupsModule } from '@modules/m103-groups/m103-groups.module';
import { AnalyticsModule } from '@modules/m110-analytics/m110-analytics.module';
