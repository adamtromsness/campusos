    ...
    <div className="mx-auto max-w-4xl">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        ...
        <InfoCard label="Permissions cached">
          ...
          <p className="mt-1 text-xs text-gray-500">
            Across all scopes assigned to this account
          </p>
        </InfoCard>
      </div>
      ...
      <div className="mt-6 rounded-card border border-gray-200 bg-white p-5 shadow-card">
        ...
        <ul className="mt-3 space-y-2 text-sm text-gray-600">
          <li>
            <span className="font-mono text-xs text-campus-600">Step 8</span>{' '}
            — Teacher dashboard (today's classes + roster)
          </li>
          <li>
            <span className="font-mono text-xs text-campus-600">Step 9</span>{' '}
            — Attendance taking UI
          </li>
          <li>
            <span className="font-mono text-xs text-campus-600">Step 10</span>{' '}
            — Parent dashboard + absence requests
          </li>
          <li>
            <span className="font-mono text-xs text-campus-600">Step 11</span>{' '}
